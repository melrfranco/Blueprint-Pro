      ...
      <div className="bg-card bp-container-tall shadow-2xl w-full max-w-md relative border border-border depth-3 overflow-hidden text-foreground">
        ...
        <div className="px-10 pb-10 pt-2">
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="bp-overline text-muted-foreground">Admin access</span>
            <div className="flex-1 h-0.5 bg-primary/30" />
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-primary text-primary-foreground font-bold text-center"
          >
            Login with Square
          </button>
          ...
          <div className="my-6 flex items-center gap-3">
            <div className="flex-1 h-0.5 bg-primary/30" />
            <span className="bp-overline text-muted-foreground">Team access</span>
            <div className="flex-1 h-0.5 bg-primary/30" />
          </div>
          ...
          {!showStylistLogin ? (
            <div className="space-y-3">
              <button
                ...
                className="w-full py-4 bg-secondary text-secondary-foreground font-bold text-center"
              >
                Stylist Login
              </button>
              <button
            ...
            <form onSubmit={handleStylistLogin} className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                data-ui="button"
                className="w-full py-4 bg-secondary text-secondary-foreground font-bold text-center disabled:opacity-50"
              >
