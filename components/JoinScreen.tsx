...
const JoinScreen: React.FC<JoinScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-primary">
      ...
      <div className="bg-card bp-container-tall shadow-2xl w-full max-w-md relative border border-border depth-3 overflow-hidden text-foreground">
        ...
        <div className="px-10 pb-10 pt-2">
          {step === 'pin' ? (
            <>
              <h2 className="bp-section-title text-center mb-2 text-foreground">Join Your Team</h2>
              ...
              <form onSubmit={handlePinSubmit} className="space-y-4">
                <div>
                  <label className="block bp-overline mb-2 text-muted-foreground">Team PIN</label>
                  <input
                    type="text"
                    inputMode="numeric"
                    maxLength={4}
                    ...
                    placeholder="0000"
                    className="w-full p-4 border-2 bp-container-compact font-bold text-2xl text-center tracking-[0.5em] outline-none bg-primary text-primary-foreground placeholder-primary-foreground/40 focus:border-accent transition-all"
                    autoFocus
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-primary text-primary-foreground font-bold text-center disabled:opacity-50"
                  data-ui="button"
                >
            ...
            <>
              <h2 className="bp-section-title text-center mb-2 text-foreground">
              ...
              <form onSubmit={handleSetup} className="space-y-4">
                <div>
                  <label className="block bp-overline mb-2 text-muted-foreground">Email</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block bp-overline mb-2 text-muted-foreground">Password</label>
                  <input
                    type="password"
                    value={password}
                ...
                <div>
                  <label className="block bp-overline mb-2 text-muted-foreground">Confirm Password</label>
                  <input
                    type="password"
